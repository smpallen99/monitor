...
var channel = socket.channel("monitor:updates", {});
...
channel.on("server:status_update", function (msg) {
  console.log('server:update', msg);
  var item = $('span.status[data-type="Server"][data-id="' + msg.id + '"]');
  item.attr('class', msg.klass).text(msg.status);
});
channel.on("service:status_update", function (msg) {
  console.log('service:update', msg);
  var item = $('span.status[data-type="Service"][data-id="' + msg.id + '"]');
  item.attr('class', msg.klass).text(msg.status);
});
